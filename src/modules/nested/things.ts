...
const THING_MAP = thingMap({
  ...
  dyson_sphere: {
    ...
    getChildren: ({ maybe, randRange, random, repeat }) => [
      "star",
      maybe("star", 0.03),
      "dyson_surface",
      ...repeat("future_planet", randRange(1, 8)),
      ...
      maybe("gas_giant", 0.2),
      maybe("gas_giant", 0.1),
      ...repeat("asteroid_belt", randRange(0, 2)),
    ],
  },
  ...
  glucids: {
    id: "glucids",
    getName: () => "Glucose",
    getChildren: () => ["carbon", "hydrogen", "oxygen"],
  },
  organic_matter: {
    id: "organic_matter",
    getName: () => "Organic Matter",
    getChildren: ({ maybe, random }) => [
      random(["proteins", "lipids", "glucids"]),
      random(["proteins", "lipids", "glucids"]),
      maybe("salt", 0.3),
    ],
  },
  ...
  cell: {
    id: "cell",
    getName: () => "Cells",
    getChildren: () => ["nucleus", "cytoplasm"],
  },
  nucleus: {
    id: "nucleus",
    getName: () => "Nucleus",
    getChildren: () => ["dna", "proteins"],
  },
  cytoplasm: {
    id: "cytoplasm",
    getName: () => "Cytoplasm",
    getChildren: () => ["glucids", "lipids"],
  },
  dna: {
    id: "dna",
    getName: () => "DNA",
  ...
  genetic_code: {
    id: "genetic_code",
    getName: () => "Genetic Code",
    getChildren: ({ repeat }) => [repeat("nucleotide", 20, 50)],
  },
  nucleotide: {
    id: "nucleotide",
    getName: ({ random }) => random(["A", "T", "G", "C"]),
    getChildren: ({ repeat }) => [repeat("nucleotide", 20, 50)],
  },
  ...
  blood_vessels: {
    id: "blood_vessels",
    getName: () => "Blood Vessels",
    getChildren: ({ maybe }) => [maybe("bacteria", 0.3), "blood"],
  },
  blood: {
    id: "blood",
    getName: () => "Blood",
    getChildren: () => ["blood_cell"],
  },
  blood_cell: {
    id: "blood_cell",
    getName: () => "Blood Cells",
  ...
  dead_skin: {
    id: "dead_skin",
    getName: () => "Dead Skin",
    getChildren: () => ["skin_cell"],
  },
  bone: {
    id: "bone",
    getName: () => "Bone",
    getChildren: () => ["bone_cell", "calcium"],
  },
  bones: {
    id: "bones",
    getName: () => "Bones",
  ...
  muscles: {
    id: "muscles",
    getName: () => "Muscles",
    getChildren: () => ["muscle_cell"],
  },
  muscle_cell: {
    id: "muscle_cell",
    getName: () => "Muscle cells",
    getChildren: () => ["nucleus", "cytoplasm"],
  },
  fat: {
    id: "fat",
  ...
  hair: {
    id: "hair",
    getName: () => "Hair",
    getChildren: ({ maybe }) => ["keratin", maybe("bacteria", 0.3)],
  },
  nose: {
    id: "nose",
    getName: () => "Nose",
  ...
  nostril_hair: {
    id: "nostril_hair",
    getName: () => "Nostril Hair",
    getChildren: ({ maybe }) => ["keratin", maybe("bacteria", 0.3)],
  },
  boogers: {
    id: "boogers",
    getName: () => "Boogers",
    getChildren: () => ["organic_matter"],
  },
  mouth: {
    id: "mouth",
    getName: () => "Mouth",
    getChildren: () => ["teeth", "tongue"],
  },
  teeth: {
    id: "teeth",
    getName: () => "Teeth",
    getChildren: () => ["calcium", "phosphorus"],
  },
  tongue: {
    id: "tongue",
    getName: () => "Tongue",
  ...
  keratin: {
    id: "keratin",
    getName: () => "Keratin",
    getChildren: () => ["proteins"],
  },
  sweat: {
    id: "sweat",
    getName: () => "Sweat",
    getChildren: () => ["water", "salt", "glucids"],
  },
  ...
  bacteria: {
    ...
    getChildren: () => ["bacteria_body", "bacteria_thoughts"],
  },
  bacteria_body: {
    id: "bacteria_body",
    getName: () => "Body",
  ...
  bacteria_thoughts: {
    id: "bacteria_thoughts",
    getName: () => "Thoughts",
    getChildren: () => [],
    getLeafs: ({ random }) => {
      const thought = random([
        "#wow",
        "#wow okay",
        "#i can't even",
        "#okay",
  ...
  future_person: {
    ...
    getChildren: () => ["body", "future_psyche", "future_clothing_set"],
  },
  ...
  future_city: {
    ...
    getName: () => "Citadion",
    getChildren: ({ repeat }) => [
      ...repeat("spaceport", 1, 3),
      ...repeat("living_center", 5, 20),
      ...repeat("spending_center", 5, 20),
    ],
  },
  ...
  spaceport: {
    ...
    getName: () => "Spaceport",
    getChildren: ({ repeat }) => [
      ...repeat("sprowseship", 4, 12),
      ...repeat("future_person", 6, 20),
      ...repeat("future_commercial_building", 2, 6),
    ],
  },
  // new Thing("spending center",["future commercial building,20-30"]);
  dyson_surface: {
    id: "dyson_surface",
    getName: () => "Dyson Surface",
    getChildren: ({ repeat }) => [...repeat("dyson_segment", 16)],
  },
  dyson_segment: {
    id: "dyson_segment",
    getName: () => "Dyson Segment",
    getChildren: ({ repeat }) => [
      ...repeat("future_city", 4, 20),
      ...repeat("nanocollector", 12, 20),
    ],
  },
  sprowseship: {
    id: "sprowseship",
    getName: () => "Sprowseship",
    getChildren: ({ repeat }) => [
      ...repeat("future_home_room", 2, 4),
      ...repeat("nanocollector", 1, 3),
    ],
  },
  ...
  nanocollector: {
    id: "nanocollector",
    getName: () => "Nanocollector",
    getChildren: ({ repeat }) => [...repeat("nanobot", 15, 30)],
  },
  nanobot: {
    id: "nanobot",
    getName: () => "Nanobot",
    getChildren: ({ repeat }) => ["silicon", "nanobot_thoughts"],
  },
  nanobot_thoughts: {
    id: "nanobot_thoughts",
    getName: () => "Thoughts",
    getChildren: () => [],
    getLeafs: ({ repeat, random }) => {
      function getThought() {
        return random([
          "all hail nanobro :]",
          "help a nanobro out :]",
          ...
          "hello world :]",
          "if I may offer my assistance, sir :]",
          "this is against the first law of nanobotics :[",
        ]);
      }
      return [...repeat("", 1, 2).map(getThought)];
    },
  },
  ...
  future_home_room: {
    id: "future_home_room",
    getName: () => "Room",
    getChildren: ({ repeat, maybe, random }) => [
      repeat("future_person", 0, 3),
      maybe("cat", 0.02),
      maybe("dog", 0.02),
      maybe("future_gizmo", 0.2),
      maybe("future_gizmo", 0.2),
      maybe("future_tv", 0.4),
      maybe("future_tv", 0.4),
      maybe("future_tv", 0.2),
      random([
        repeat("future_bathroom_stuff", 2, 4),
        repeat("future_living_room_stuff", 3, 7),
        repeat("future_bedroom_stuff", 2, 6),
      ]),
      repeat("future_decoration_stuff", 0, 3),
      repeat("future_door", 1, 2),
      "nanocarpet",
      repeat("future_wall", 4),
    ],
  },
