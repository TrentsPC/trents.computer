              ...
              <Show when={showGuides()}>
                ...
                <div
                  style={{
                    ...
                    top: 0,
                    bottom: 0,
                    left: GLYPH_CANVAS_MIDPOINT * zoom() - 0.5 + "px",
                ...
                <div
                  style={{
                    ...
                    bottom: 0,
                    left:
                      (glyph().advanceWidth + GLYPH_CANVAS_MIDPOINT) * zoom() -
                      0.5 +
                      "px",
                    "border-left": "1.5px dashed #f59e0b88",
                    "z-index": 5,
