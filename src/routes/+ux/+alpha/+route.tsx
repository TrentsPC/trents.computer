      ...
      >
        <DialogBody css={{ width: 400 }}>
          ...
          <Dialog.Description css={{ margin: "20px 0" }}>
            ...
            to your birthday. Please enter the relevant 6-digit code generated
            by your authenticator app to perform your desired action.
          </Dialog.Description>
          <Dialog.CloseButton
            css={{
              backgroundColor: "white",
...
function MFASetupDialog(props: { otp: OTPAuth.TOTP }) {
  ...
  return (
    <Dialog.Root open={open()} onOpenChange={setOpen}>
      ...
      >
        Set up two-factor authentication for using{" "}
        {props.otp.label.toLowerCase()}
      </Dialog.Trigger>
      <Dialog.Portal>
        <Dialog.Overlay
          css={{
