...
export const otps = {
  totp0: createTOTP(secret0, "The Number 0"),
  totp1: createTOTP(secret1, "The Number 1"),
  totp2: createTOTP(secret2, "The Number 2"),
  totp3: createTOTP(secret3, "The Number 3"),
  totp4: createTOTP(secret4, "The Number 4"),
  totp5: createTOTP(secret5, "The Number 5"),
  totp6: createTOTP(secret6, "The Number 6"),
  totp7: createTOTP(secret7, "The Number 7"),
  totp8: createTOTP(secret8, "The Number 8"),
  totp9: createTOTP(secret9, "The Number 9"),
